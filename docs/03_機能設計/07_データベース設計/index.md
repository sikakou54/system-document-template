...
- テーブル一覧のほか、ER図は ER図.md、共通コード値は 10_共通定義設計/共通コード定義.md を参照、共通カラムは 共通カラム.md、命名規則は 命名規則.md を参照。
...
| TBL-009 | 監査ログトランザクション | T_AUDIT_LOGS | 重要操作の監査証跡(追記のみ。CFR-007／NFR-006) |
