...
| SCR-002 会議室検索 | API-002 | MOD-002 | TBL-002, TBL-003, TBL-004, TBL-005 |
| SCR-003 予約登録 | API-003 | MOD-003 | TBL-003, TBL-002 |
| SCR-004 予約一覧・変更・キャンセル | API-006, API-004, API-005 | MOD-003 | TBL-003, TBL-002 |
| SCR-005 会議室・設備管理 | API-007, API-009 | MOD-004 | TBL-002, TBL-004, TBL-005 |
| SCR-006 利用実績 | API-008 | MOD-005 | TBL-003, TBL-006 |
