...
画面ID・画面名は§3.1 画面一覧を、利用APIのAPI-ID・API名は§5.2 API一覧を構成上の正本とし、本章は各画面のレイアウト・項目・イベント・状態・遷移を詳細化する。
...
本表は各画面の基本情報・初期表示・イベントで参照する利用APIと、各§5.x.7の全エラーコード、画面が表示するMSGの対応を正逆両方向に検証した結果である。API-ID・Method・PathとERRコードは§5を、MSGは§3.0.1および各画面のメッセージ一覧を正本とする。UNAUTHENTICATEDは§3.0で共通処理するため共通行へ集約し、個別画面へ重複定義しない。

| 画面ID | API-ID | 呼出箇所 | §5 Method / Path | ERRコード | 画面側処理 | MSG-ID | 整合結果 |
|---|---|---|---|---|---|---|---|
| SCR-001〜009・SCR-011 | 各利用API | 全API呼出（初期表示・各EVT） | 各利用API（§5.2） | `UNAUTHENTICATED` | §3.0共通（認証情報破棄・進行中要求取消・SCR-010遷移） | MSG-12 | OK |
| SCR-001 | API-001 | 初期表示・EVT-01・EVT-06 | GET `/api/employees` | `VALIDATION_ERROR` | §3.3.7 条件不正 | MSG-98 | OK |
| SCR-001 | API-001 | 初期表示・EVT-01・EVT-06 | GET `/api/employees` | `FORBIDDEN` | §3.3.7 検索権限なし | MSG-99 | OK |
| SCR-001 | API-001 | 初期表示・EVT-01・EVT-06 | GET `/api/employees` | `INTERNAL_ERROR` | §3.3.7 システムエラー | MSG-13 | OK |
| SCR-001 | API-008 | 初期表示 | GET `/api/organizations` | `VALIDATION_ERROR` | §3.3.3 異常時 | MSG-98 | OK |
| SCR-001 | API-008 | 初期表示 | GET `/api/organizations` | `FORBIDDEN` | §3.3.3 異常時 | MSG-102 | OK |
| SCR-001 | API-008 | 初期表示 | GET `/api/organizations` | `INTERNAL_ERROR` | §3.3.3 異常時 | MSG-13 | OK |
| SCR-001 | API-009 | 初期表示 | GET `/api/positions` | `VALIDATION_ERROR` | §3.3.3 異常時 | MSG-98 | OK |
| SCR-001 | API-009 | 初期表示 | GET `/api/positions` | `FORBIDDEN` | §3.3.3 異常時 | MSG-102 | OK |
| SCR-001 | API-009 | 初期表示 | GET `/api/positions` | `INTERNAL_ERROR` | §3.3.3 異常時 | MSG-13 | OK |
| SCR-001 | API-018 | EVT-05 | POST `/api/employees/export` | `VALIDATION_ERROR` | §3.3.7 条件不正 | MSG-98 | OK |
| SCR-001 | API-018 | EVT-05 | POST `/api/employees/export` | `FORBIDDEN` | §3.3.7 出力権限なし | MSG-15 | OK |
| SCR-001 | API-018 | EVT-05 | POST `/api/employees/export` | `EXPORT_TARGET_EMPTY` | §3.3.5 EVT-05失敗時 | MSG-14 | OK |
| SCR-001 | API-018 | EVT-05 | POST `/api/employees/export` | `EXPORT_LIMIT_EXCEEDED` | §3.3.7 出力上限超過 | MSG-87 | OK |
| SCR-001 | API-018 | EVT-05 | POST `/api/employees/export` | `INTERNAL_ERROR` | §3.3.7 システムエラー | MSG-13 | OK |
| SCR-002 | API-002 | 初期表示・EVT-01 | GET `/api/employees/{employeeId}` | `VALIDATION_ERROR` / `EMPLOYEE_NOT_FOUND` | §3.4.7 対象不存在 | MSG-17 | OK |
| SCR-002 | API-002 | 初期表示・EVT-01 | GET `/api/employees/{employeeId}` | `FORBIDDEN` | §3.4.7 閲覧権限なし | MSG-18 | OK |
| SCR-002 | API-002 | 初期表示・EVT-01 | GET `/api/employees/{employeeId}` | `INTERNAL_ERROR` | §3.4.7 システムエラー | MSG-20 | OK |
| SCR-003 | API-003 | EVT-01 | POST `/api/employees` | `VALIDATION_ERROR` | §3.5.7 入力エラー | MSG-01 | OK |
| SCR-003 | API-003 | EVT-01 | POST `/api/employees` | `EMPLOYEE_NUMBER_DUPLICATED` | §3.5.7 社員番号重複 | MSG-02 | OK |
| SCR-003 | API-003 | EVT-01 | POST `/api/employees` | `EMAIL_DUPLICATED` | §3.5.7 メール重複 | MSG-03 | OK |
| SCR-003 | API-003 | EVT-01 | POST `/api/employees` | `MASTER_NOT_ACTIVE` | §3.5.7 マスター無効 | MSG-06 | OK |
| SCR-003 | API-003 | EVT-01 | POST `/api/employees` | `FORBIDDEN` | §3.5.7 権限エラー | MSG-07 | OK |
| SCR-003 | API-003 | EVT-01 | POST `/api/employees` | `INTERNAL_ERROR` | §3.5.7 システムエラー | MSG-08 | OK |
| SCR-003 | API-008 | 初期表示・EVT-03・EVT-04 | GET `/api/organizations` | `VALIDATION_ERROR` | §3.5.3 異常時 | MSG-01 | OK |
| SCR-003 | API-008 | 初期表示・EVT-03・EVT-04 | GET `/api/organizations` | `FORBIDDEN` | §3.5.3 異常時 | MSG-07 | OK |
| SCR-003 | API-008 | 初期表示・EVT-03・EVT-04 | GET `/api/organizations` | `INTERNAL_ERROR` | §3.5.3 異常時 | MSG-08 | OK |
| SCR-003 | API-009 | 初期表示・EVT-03・EVT-04 | GET `/api/positions` | `VALIDATION_ERROR` | §3.5.3 異常時 | MSG-01 | OK |
| SCR-003 | API-009 | 初期表示・EVT-03・EVT-04 | GET `/api/positions` | `FORBIDDEN` | §3.5.3 異常時 | MSG-07 | OK |
| SCR-003 | API-009 | 初期表示・EVT-03・EVT-04 | GET `/api/positions` | `INTERNAL_ERROR` | §3.5.3 異常時 | MSG-08 | OK |
| SCR-004 | API-002 | 初期表示・EVT-02 | GET `/api/employees/{employeeId}` | `VALIDATION_ERROR` | §3.6.3 異常時 | MSG-21 | OK |
| SCR-004 | API-002 | 初期表示・EVT-02 | GET `/api/employees/{employeeId}` | `FORBIDDEN` | §3.6.7 権限エラー | MSG-26 | OK |
| SCR-004 | API-002 | 初期表示・EVT-02 | GET `/api/employees/{employeeId}` | `EMPLOYEE_NOT_FOUND` | §3.6.7 対象不存在 | MSG-27 | OK |
| SCR-004 | API-002 | 初期表示・EVT-02 | GET `/api/employees/{employeeId}` | `INTERNAL_ERROR` | §3.6.7 システムエラー | MSG-28 | OK |
| SCR-004 | API-004 | EVT-01 | PUT `/api/employees/{employeeId}` | `VALIDATION_ERROR` | §3.6.7 入力エラー | MSG-21 | OK |
| SCR-004 | API-004 | EVT-01 | PUT `/api/employees/{employeeId}` | `EMAIL_DUPLICATED` | §3.6.7 メール重複 | MSG-22 | OK |
| SCR-004 | API-004 | EVT-01 | PUT `/api/employees/{employeeId}` | `UPDATE_CONFLICT` | §3.6.7 更新競合 | MSG-23 | OK |
| SCR-004 | API-004 | EVT-01 | PUT `/api/employees/{employeeId}` | `FORBIDDEN` | §3.6.7 権限エラー | MSG-26 | OK |
| SCR-004 | API-004 | EVT-01 | PUT `/api/employees/{employeeId}` | `EMPLOYEE_NOT_FOUND` | §3.6.7 対象不存在 | MSG-27 | OK |
| SCR-004 | API-004 | EVT-01 | PUT `/api/employees/{employeeId}` | `INTERNAL_ERROR` | §3.6.7 システムエラー | MSG-28 | OK |
| SCR-005 | API-001 | EVT-04 | GET `/api/employees` | `VALIDATION_ERROR` | §3.7.5 EVT-04失敗時 | MSG-30 | OK |
| SCR-005 | API-001 | EVT-04 | GET `/api/employees` | `FORBIDDEN` | §3.7.5 EVT-04失敗時 | MSG-37 | OK |
| SCR-005 | API-001 | EVT-04 | GET `/api/employees` | `INTERNAL_ERROR` | §3.7.5 EVT-04失敗時 | MSG-38 | OK |
| SCR-005 | API-002 | 初期表示 | GET `/api/employees/{employeeId}` | `VALIDATION_ERROR` | §3.7.3 異常時 | MSG-30 | OK |
| SCR-005 | API-002 | 初期表示 | GET `/api/employees/{employeeId}` | `FORBIDDEN` | §3.7.7 権限エラー | MSG-37 | OK |
| SCR-005 | API-002 | 初期表示 | GET `/api/employees/{employeeId}` | `EMPLOYEE_NOT_FOUND` | §3.7.7 対象外 | MSG-31 | OK |
| SCR-005 | API-002 | 初期表示 | GET `/api/employees/{employeeId}` | `INTERNAL_ERROR` | §3.7.7 システムエラー | MSG-38 | OK |
| SCR-005 | API-005 | EVT-01 | POST `/api/employees/{employeeId}/assignments` | `VALIDATION_ERROR` | §3.7.5 EVT-01失敗時 | MSG-30 | OK |
| SCR-005 | API-005 | EVT-01 | POST `/api/employees/{employeeId}/assignments` | `EMPLOYEE_NOT_FOUND` / `EMPLOYEE_ALREADY_RETIRED` | §3.7.7 対象外 | MSG-31 | OK |
| SCR-005 | API-005 | EVT-01 | POST `/api/employees/{employeeId}/assignments` | `MASTER_NOT_ACTIVE` | §3.7.7 マスター・上長無効 | MSG-32 | OK |
| SCR-005 | API-005 | EVT-01 | POST `/api/employees/{employeeId}/assignments` | `ASSIGNMENT_PERIOD_CONFLICT` / `INVALID_TRANSFER_DATE` | §3.7.7 期間重複 | MSG-33 | OK |
| SCR-005 | API-005 | EVT-01 | POST `/api/employees/{employeeId}/assignments` | `FORBIDDEN` | §3.7.7 権限エラー | MSG-37 | OK |
| SCR-005 | API-005 | EVT-01 | POST `/api/employees/{employeeId}/assignments` | `UPDATE_CONFLICT` | §3.7.7 更新競合 | MSG-88 | OK |
| SCR-005 | API-005 | EVT-01 | POST `/api/employees/{employeeId}/assignments` | `INTERNAL_ERROR` | §3.7.7 システムエラー | MSG-38 | OK |
| SCR-005 | API-008 | 初期表示・EVT-03・EVT-05 | GET `/api/organizations` | `VALIDATION_ERROR` | §3.7.3 異常時 | MSG-30 | OK |
| SCR-005 | API-008 | 初期表示・EVT-03・EVT-05 | GET `/api/organizations` | `FORBIDDEN` | §3.7.7 権限エラー | MSG-37 | OK |
| SCR-005 | API-008 | 初期表示・EVT-03・EVT-05 | GET `/api/organizations` | `INTERNAL_ERROR` | §3.7.7 システムエラー | MSG-38 | OK |
| SCR-005 | API-009 | 初期表示・EVT-03・EVT-05 | GET `/api/positions` | `VALIDATION_ERROR` | §3.7.3 異常時 | MSG-30 | OK |
| SCR-005 | API-009 | 初期表示・EVT-03・EVT-05 | GET `/api/positions` | `FORBIDDEN` | §3.7.7 権限エラー | MSG-37 | OK |
| SCR-005 | API-009 | 初期表示・EVT-03・EVT-05 | GET `/api/positions` | `INTERNAL_ERROR` | §3.7.7 システムエラー | MSG-38 | OK |
| SCR-006 | API-002 | 初期表示 | GET `/api/employees/{employeeId}` | `VALIDATION_ERROR` / `EMPLOYEE_NOT_FOUND` | §3.8.7 対象外 | MSG-41 | OK |
| SCR-006 | API-002 | 初期表示 | GET `/api/employees/{employeeId}` | `FORBIDDEN` | §3.8.7 権限エラー | MSG-45 | OK |
| SCR-006 | API-002 | 初期表示 | GET `/api/employees/{employeeId}` | `INTERNAL_ERROR` | §3.8.7 システムエラー | MSG-46 | OK |
| SCR-006 | API-006 | EVT-01 | POST `/api/employees/{employeeId}/retirement` | `VALIDATION_ERROR` / `INVALID_RETIREMENT_DATE` | §3.8.7 退職日・上長参照不正 | MSG-40 | OK |
| SCR-006 | API-006 | EVT-01 | POST `/api/employees/{employeeId}/retirement` | `EMPLOYEE_NOT_FOUND` / `EMPLOYEE_ALREADY_RETIRED` | §3.8.7 対象外 | MSG-41 | OK |
| SCR-006 | API-006 | EVT-01 | POST `/api/employees/{employeeId}/retirement` | `FORBIDDEN` | §3.8.7 権限エラー | MSG-45 | OK |
| SCR-006 | API-006 | EVT-01 | POST `/api/employees/{employeeId}/retirement` | `UPDATE_CONFLICT` | §3.8.7 更新競合 | MSG-89 | OK |
| SCR-006 | API-006 | EVT-01 | POST `/api/employees/{employeeId}/retirement` | `INTERNAL_ERROR` | §3.8.7 システムエラー | MSG-46 | OK |
| SCR-007 | API-002 | 初期表示 | GET `/api/employees/{employeeId}` | `VALIDATION_ERROR` / `EMPLOYEE_NOT_FOUND` | §3.9.7 対象不存在 | MSG-100 | OK |
| SCR-007 | API-002 | 初期表示 | GET `/api/employees/{employeeId}` | `FORBIDDEN` | §3.9.7 権限エラー | MSG-51 | OK |
| SCR-007 | API-002 | 初期表示 | GET `/api/employees/{employeeId}` | `INTERNAL_ERROR` | §3.9.7 システムエラー | MSG-52 | OK |
| SCR-007 | API-007 | 初期表示・EVT-01・EVT-04 | GET `/api/employees/{employeeId}/history` | `FORBIDDEN` | §3.9.7 権限エラー | MSG-51 | OK |
| SCR-007 | API-007 | 初期表示・EVT-01・EVT-04 | GET `/api/employees/{employeeId}/history` | `EMPLOYEE_NOT_FOUND` | §3.9.7 対象不存在 | MSG-100 | OK |
| SCR-007 | API-007 | 初期表示・EVT-01・EVT-04 | GET `/api/employees/{employeeId}/history` | `VALIDATION_ERROR` / `INTERNAL_ERROR` | §3.9.7 システムエラー | MSG-52 | OK |
| SCR-008 | API-008 | 初期表示・EVT-02〜04 | GET `/api/organizations` | `VALIDATION_ERROR` | §3.10.7 入力エラー | MSG-53 | OK |
| SCR-008 | API-008 | 初期表示・EVT-02〜04 | GET `/api/organizations` | `FORBIDDEN` | §3.10.7 権限エラー | MSG-58 | OK |
| SCR-008 | API-008 | 初期表示・EVT-02〜04 | GET `/api/organizations` | `INTERNAL_ERROR` | §3.10.7 システムエラー | MSG-59 | OK |
| SCR-008 | API-011 | EVT-02 | POST `/api/organizations` | `VALIDATION_ERROR` | §3.10.7 入力エラー | MSG-53 | OK |
| SCR-008 | API-011 | EVT-02 | POST `/api/organizations` | `ORGANIZATION_CODE_DUPLICATED` | §3.10.7 コード重複 | MSG-54 | OK |
| SCR-008 | API-011 | EVT-02 | POST `/api/organizations` | `MASTER_PERIOD_INVALID` | §3.10.7 期間不正 | MSG-91 | OK |
| SCR-008 | API-011 | EVT-02 | POST `/api/organizations` | `ORGANIZATION_HIERARCHY_CONFLICT` | §3.10.7 階層不整合 | MSG-92 | OK |
| SCR-008 | API-011 | EVT-02 | POST `/api/organizations` | `FORBIDDEN` | §3.10.7 権限エラー | MSG-58 | OK |
| SCR-008 | API-011 | EVT-02 | POST `/api/organizations` | `INTERNAL_ERROR` | §3.10.7 システムエラー | MSG-59 | OK |
| SCR-008 | API-012 | EVT-03・EVT-04 | PUT `/api/organizations/{organizationId}` | `VALIDATION_ERROR` | §3.10.7 入力エラー | MSG-53 | OK |
| SCR-008 | API-012 | EVT-03・EVT-04 | PUT `/api/organizations/{organizationId}` | `MASTER_PERIOD_INVALID` | §3.10.7 期間不正 | MSG-91 | OK |
| SCR-008 | API-012 | EVT-03・EVT-04 | PUT `/api/organizations/{organizationId}` | `ORGANIZATION_HIERARCHY_CONFLICT` | §3.10.7 階層不整合 | MSG-92 | OK |
| SCR-008 | API-012 | EVT-03・EVT-04 | PUT `/api/organizations/{organizationId}` | `ORGANIZATION_NOT_FOUND` | §3.10.7 対象不存在 | MSG-93 | OK |
| SCR-008 | API-012 | EVT-03・EVT-04 | PUT `/api/organizations/{organizationId}` | `UPDATE_CONFLICT` | §3.10.7 更新競合 | MSG-94 | OK |
| SCR-008 | API-012 | EVT-03・EVT-04 | PUT `/api/organizations/{organizationId}` | `FORBIDDEN` | §3.10.7 権限エラー | MSG-58 | OK |
| SCR-008 | API-012 | EVT-03・EVT-04 | PUT `/api/organizations/{organizationId}` | `INTERNAL_ERROR` | §3.10.7 システムエラー | MSG-59 | OK |
| SCR-009 | API-009 | 初期表示・EVT-02〜04 | GET `/api/positions` | `VALIDATION_ERROR` | §3.11.7 入力エラー | MSG-62 | OK |
| SCR-009 | API-009 | 初期表示・EVT-02〜04 | GET `/api/positions` | `FORBIDDEN` | §3.11.7 権限エラー | MSG-67 | OK |
| SCR-009 | API-009 | 初期表示・EVT-02〜04 | GET `/api/positions` | `INTERNAL_ERROR` | §3.11.7 システムエラー | MSG-68 | OK |
| SCR-009 | API-013 | EVT-02 | POST `/api/positions` | `VALIDATION_ERROR` | §3.11.7 入力エラー | MSG-62 | OK |
| SCR-009 | API-013 | EVT-02 | POST `/api/positions` | `POSITION_CODE_DUPLICATED` | §3.11.7 コード重複 | MSG-63 | OK |
| SCR-009 | API-013 | EVT-02 | POST `/api/positions` | `MASTER_PERIOD_INVALID` | §3.11.7 期間不正 | MSG-95 | OK |
| SCR-009 | API-013 | EVT-02 | POST `/api/positions` | `FORBIDDEN` | §3.11.7 権限エラー | MSG-67 | OK |
| SCR-009 | API-013 | EVT-02 | POST `/api/positions` | `INTERNAL_ERROR` | §3.11.7 システムエラー | MSG-68 | OK |
| SCR-009 | API-014 | EVT-03・EVT-04 | PUT `/api/positions/{positionId}` | `VALIDATION_ERROR` | §3.11.7 入力エラー | MSG-62 | OK |
| SCR-009 | API-014 | EVT-03・EVT-04 | PUT `/api/positions/{positionId}` | `MASTER_PERIOD_INVALID` | §3.11.7 期間不正 | MSG-95 | OK |
| SCR-009 | API-014 | EVT-03・EVT-04 | PUT `/api/positions/{positionId}` | `POSITION_NOT_FOUND` | §3.11.7 対象不存在 | MSG-96 | OK |
| SCR-009 | API-014 | EVT-03・EVT-04 | PUT `/api/positions/{positionId}` | `UPDATE_CONFLICT` | §3.11.7 更新競合 | MSG-97 | OK |
| SCR-009 | API-014 | EVT-03・EVT-04 | PUT `/api/positions/{positionId}` | `FORBIDDEN` | §3.11.7 権限エラー | MSG-67 | OK |
| SCR-009 | API-014 | EVT-03・EVT-04 | PUT `/api/positions/{positionId}` | `INTERNAL_ERROR` | §3.11.7 システムエラー | MSG-68 | OK |
| SCR-010 | API-010 | EVT-01 | POST `/api/auth/login` | `VALIDATION_ERROR` | §3.12.5 EVT-01失敗時 | MSG-71 | OK |
| SCR-010 | API-010 | EVT-01 | POST `/api/auth/login` | `AUTHENTICATION_FAILED` | §3.12.7 認証情報誤り | MSG-72 | OK |
| SCR-010 | API-010 | EVT-01 | POST `/api/auth/login` | `ACCOUNT_INACTIVE` | §3.12.7 アカウント無効・ロック | MSG-73 | OK |
| SCR-010 | API-010 | EVT-01 | POST `/api/auth/login` | `AUTHENTICATION_SERVICE_UNAVAILABLE` | §3.12.7 認証基盤利用不能 | MSG-90 | OK |
| SCR-010 | API-010 | EVT-01 | POST `/api/auth/login` | `INTERNAL_ERROR` | §3.12.7 システムエラー | MSG-75 | OK |
| SCR-011 | API-001 | EVT-01・EVT-06 | GET `/api/employees` | `VALIDATION_ERROR` | §3.13.5 EVT-01/06失敗時 | MSG-76 | OK |
| SCR-011 | API-001 | EVT-01・EVT-06 | GET `/api/employees` | `FORBIDDEN` | §3.13.7 権限エラー | MSG-81 | OK |
| SCR-011 | API-001 | EVT-01・EVT-06 | GET `/api/employees` | `INTERNAL_ERROR` | §3.13.7 システムエラー | MSG-82 | OK |
| SCR-011 | API-008 | 初期表示 | GET `/api/organizations` | `VALIDATION_ERROR` | §3.13.3 異常時 | MSG-76 | OK |
| SCR-011 | API-008 | 初期表示 | GET `/api/organizations` | `FORBIDDEN` | §3.13.7 権限エラー | MSG-81 | OK |
| SCR-011 | API-008 | 初期表示 | GET `/api/organizations` | `INTERNAL_ERROR` | §3.13.7 システムエラー | MSG-82 | OK |
| SCR-011 | API-015 | 初期表示 | GET `/api/roles` | `FORBIDDEN` | §3.13.7 権限エラー | MSG-81 | OK |
| SCR-011 | API-015 | 初期表示 | GET `/api/roles` | `INTERNAL_ERROR` | §3.13.7 システムエラー | MSG-82 | OK |
| SCR-011 | API-016 | EVT-02 | GET `/api/employees/{employeeId}/roles` | `VALIDATION_ERROR` | §3.13.5 EVT-02失敗時 | MSG-76 | OK |
| SCR-011 | API-016 | EVT-02 | GET `/api/employees/{employeeId}/roles` | `EMPLOYEE_NOT_FOUND` / `USER_ACCOUNT_NOT_FOUND` | §3.13.7 対象不存在 | MSG-77 | OK |
| SCR-011 | API-016 | EVT-02 | GET `/api/employees/{employeeId}/roles` | `FORBIDDEN` | §3.13.7 権限エラー | MSG-81 | OK |
| SCR-011 | API-016 | EVT-02 | GET `/api/employees/{employeeId}/roles` | `INTERNAL_ERROR` | §3.13.7 システムエラー | MSG-82 | OK |
| SCR-011 | API-017 | EVT-03 | PUT `/api/employees/{employeeId}/roles` | `VALIDATION_ERROR` | §3.13.5 EVT-03失敗時 | MSG-76 | OK |
| SCR-011 | API-017 | EVT-03 | PUT `/api/employees/{employeeId}/roles` | `EMPLOYEE_NOT_FOUND` / `USER_ACCOUNT_NOT_FOUND` | §3.13.7 対象不存在 | MSG-77 | OK |
| SCR-011 | API-017 | EVT-03 | PUT `/api/employees/{employeeId}/roles` | `ROLE_NOT_ACTIVE` | §3.13.7 ロール無効 | MSG-78 | OK |
| SCR-011 | API-017 | EVT-03 | PUT `/api/employees/{employeeId}/roles` | `ROLE_ASSIGNMENT_PERIOD_CONFLICT` | §3.13.7 期間不正 | MSG-85 | OK |
| SCR-011 | API-017 | EVT-03 | PUT `/api/employees/{employeeId}/roles` | `USER_ACCOUNT_INACTIVE` | §3.13.7 アカウント無効 | MSG-86 | OK |
| SCR-011 | API-017 | EVT-03 | PUT `/api/employees/{employeeId}/roles` | `UPDATE_CONFLICT` | §3.13.7 更新競合 | MSG-101 | OK |
| SCR-011 | API-017 | EVT-03 | PUT `/api/employees/{employeeId}/roles` | `FORBIDDEN` | §3.13.7 権限エラー | MSG-81 | OK |
| SCR-011 | API-017 | EVT-03 | PUT `/api/employees/{employeeId}/roles` | `INTERNAL_ERROR` | §3.13.7 システムエラー | MSG-82 | OK |
